...
class Event(models.Model):
    ...
    room = models.ManyToManyField(Halls, through='Location', verbose_name='Зал', blank=True)
    room_in_list = models.ManyToManyField(HallList, through='LocList', verbose_name='Отображение в списке', blank=True)
